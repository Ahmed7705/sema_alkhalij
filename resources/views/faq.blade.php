<x-app-layout title="الأسئلة الشائعة | سيما الخليج">
    ...
    <section class="py-16 bg-surface">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            @php
            $allFaqs = [
                ['q' => 'كيف يمكنني حجز زيارة طبية منزلية من سيما الخليج؟', 'a' => 'اختر الخدمة المطلوبة من موقعنا الإلكتروني، حدد التاريخ والوقت المناسب والمدينة، أو يمكنك الضغط على زر "اطلب معاودة اتصال" وسيتواصل معك فريق خدمة العملاء فوراً لتأكيد الحجز ومساعدتك.'],
