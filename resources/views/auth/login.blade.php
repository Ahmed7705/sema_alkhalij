    ...
    <div class="w-full min-h-screen p-4 sm:p-6 flex items-center justify-center relative z-10">
        ...
        <div class="bg-white rounded-3xl shadow-floating border border-gray-100 overflow-hidden w-full max-w-4xl grid grid-cols-1 lg:grid-cols-12 gap-0">
            ...
            <div class="lg:col-span-7 p-6 sm:p-10 flex flex-col justify-center space-y-6">
                ...
                {{-- Alert Messages --}}
                @if(session('success'))
                    <div class="p-3.5 bg-emerald-50 border border-emerald-200 text-emerald-800 text-xs rounded-xl flex items-center gap-2.5 font-bold shadow-sm">
                ...
                <form action="{{ route('login') }}" method="POST" class="space-y-4">
                    ...
                    <div class="space-y-1.5 text-right">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="login" value="{{ old('login') }}" required placeholder="05xxxxxxxx أو name@example.com" class="w-full pr-10 pl-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-xs sm:text-sm focus:outline-none focus:border-primary focus:bg-white transition-all text-right">
                        </div>
                    </div>

                    {{-- Password Input --}}
                    <div class="space-y-1.5 text-right" x-data="{ showPass: false }">
                        ...
                        <div class="relative">
                            ...
                            <input :type="showPass ? 'text' : 'password'" name="password" required placeholder="••••••••" class="w-full pr-10 pl-10 py-3 bg-gray-50 border border-gray-200 rounded-xl text-xs sm:text-sm focus:outline-none focus:border-primary focus:bg-white transition-all text-right">
                        ...
                        <div class="flex justify-start pt-1">
                            <a href="{{ route('password.request') }}" class="text-[11px] font-bold text-accent hover:underline">نسيت كلمة المرور؟</a>
                        </div>
                    </div>
                ...
                <div class="flex items-center gap-3 pt-2">
                    <span class="text-[11px] font-bold text-gray-500 shrink-0">أو تسجيل الدخول السريع عبر:</span>
                ...
                <div class="grid grid-cols-2 gap-3">
                    ...
                    {{-- Apple Button with guaranteed high-contrast styling --}}
