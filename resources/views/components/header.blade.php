    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-[72px]">
            ...
            <div class="flex items-center gap-2 sm:gap-3">
                ...
                @guest
                    <a href="{{ route('login') }}" class="hidden sm:inline-flex items-center gap-1.5 px-3 py-2 text-xs font-bold text-primary bg-medical-50 hover:bg-primary hover:text-white rounded-xl transition-all border border-primary/15" title="تسجيل الدخول">
            ...
            <div x-show="mobileMenuOpen" x-cloak
                ...
                {{-- Mobile Login Button --}}
                @guest
                    <a href="{{ route('login') }}" class="w-full btn-accent py-2.5 rounded-xl font-bold text-xs flex items-center justify-center gap-2 mb-2">
