...
<body class="bg-[#F6F9F7] font-sans text-gray-800 antialiased h-screen overflow-hidden flex" x-data="{ sidebarOpen: false }">
    ...
    <aside :class="sidebarOpen ? 'translate-x-0' : 'translate-x-full lg:translate-x-0'"
        ...
        <nav class="p-4 space-y-4 flex-1 overflow-y-auto">
            ...
            {{-- Section 1: Dashboard --}}
            <div class="space-y-1">
                <span class="px-3 text-[10px] font-black text-accent tracking-wider uppercase block mb-1">الرئيسية والتحليلات</span>
            ...
            <div class="space-y-1 pt-2 border-t border-white/10">
                <span class="px-3 text-[10px] font-black text-accent tracking-wider uppercase block mb-1">العمليات والزيارات الطبية</span>
                <a href="{{ route('admin.bookings.index') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-2xl text-xs font-bold transition-all {{ request()->routeIs('admin.bookings.*') ? 'bg-accent text-white shadow-md' : 'text-medical-200 hover:bg-white/10 hover:text-white' }}">
                    ...
                    <span>طلبات الخدمات والزيارات</span>
                </a>
            ...
            <div class="space-y-1 pt-2 border-t border-white/10">
                <span class="px-3 text-[10px] font-black text-accent tracking-wider uppercase block mb-1">إدارة الشركات والتعاقدات</span>
                <a href="{{ route('company.portal') }}" target="_blank" class="flex items-center gap-3 px-4 py-2.5 rounded-2xl text-xs font-bold transition-all text-medical-200 hover:bg-white/10 hover:text-white">
                    ...
                    <span>بوابة الشركات والمستفيدين</span>
                </a>
            ...
            <div class="space-y-1 pt-2 border-t border-white/10">
                <span class="px-3 text-[10px] font-black text-accent tracking-wider uppercase block mb-1">المتجر والفوترة</span>
            ...
            <div class="space-y-1 pt-2 border-t border-white/10">
                <span class="px-3 text-[10px] font-black text-accent tracking-wider uppercase block mb-1">المحتوى والإعدادات والنظام</span>
